...
alias school="cd  /Users/yt/Library/Mobile\ Documents/com~apple~CloudDocs/2021Spring"
...
__conda_setup="$('/Users/yt/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/yt/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/yt/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/yt/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
#PROMPT=$(echo $PROMPT | sed 's/(base) //') #remove (base) prompt
